package com.timohani.tutorialmod.world;
...
public class ModPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> DRIFTWOOD_PLACE_KEY = registerKey("driftwood_placed");

    public static final RegistryKey<PlacedFeature> HONEY_BERRY_BUSH_PLACE_KEY = registerKey("honey_berry_bush_placed");
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, DRIFTWOOD_PLACE_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.DRIFTWOOD_KEY),
                VegetationPlacedFeatures.treeModifiersWithWouldSurvive(
                        PlacedFeatures.createCountExtraModifier(2, 0.1f, 2), ModBlocks.DRIFTWOOD_SAPLING));

        register(context, HONEY_BERRY_BUSH_PLACE_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.HONEY_BERRY_BUSH_KEY),
