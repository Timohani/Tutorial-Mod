package com.timohani.tutorialmod.block.entity.custom;
...
import com.timohani.tutorialmod.screen.custom.PedestalScreenHandler;
...
public class PedestalBlockEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<BlockPos> {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.tutorialmod.pedestal");
    }
